...
public class _03_WebElementGetText {
    public static void main(String[] args) {
        ...
        System.out.println(labelFirstName.getText()); //Web elementin ekranda cıkan yazısı

        WebElement labelLastName = driver.findElement(By.id("sublabel_8_last"));
        System.out.println(labelLastName.getText()); //Web elementin ekranda cıkan yazısı
